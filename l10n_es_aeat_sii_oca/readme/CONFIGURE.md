...
1.  l10n_es_aeat_sii_oca.sii_batch: Almacena el número de facturas máximo
    que se enviarán al SII cada vez que se realice un envío. El valor por defecto es 50.
2.  l10n_es_aeat_sii_oca.sii_retry: Almacena el número de veces que se intentará enviar
    una factura al SII en caso de error en el envío. El valor por defecto es 5.
