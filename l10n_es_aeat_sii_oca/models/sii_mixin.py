...
class SiiMixin(models.AbstractModel):
    ...
    sii_cancel_date = fields.Datetime(string="SII Cancel Date")
    sii_retry_no = fields.Integer()
        ...
        for document in self.filtered(
            ...
            try:
                ...
                retry = int(
                    ...
                    .sudo()
                    .get_param("l10n_es_aeat_sii_oca.sii_retry", "5")
                )
                if retry > document.sii_retry_no:
                    doc_vals["sii_retry_no"] = document.sii_retry_no + 1
