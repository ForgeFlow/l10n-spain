...
class AccountMoveSend(models.TransientModel):
    ...
    def _l10n_es_edi_verifactu_get_move_info(self):
        ...
        verifactu_moves = self.move_ids.filtered(
        ...
        registered_moves = verifactu_moves.filtered(
            lambda m: m.l10n_es_edi_verifactu_state
    ...
    @api.depends(
        "move_ids.l10n_es_edi_verifactu_required",
        "move_ids.l10n_es_edi_verifactu_state",
    )
    def _compute_l10n_es_edi_verifactu_compute_checkbox(self):
        for wizard in self:
            ...
            wizard.l10n_es_edi_verifactu_send_readonly = (
                not enable or not move_info["moves_to_send"]
            )
        ...
        for invoice in invoices_to_send:
            ...
            if document and document.state == "creating_failed":
                invoices_data[invoice]["error"] = {
                    "error_title": _(
                        "The Veri*Factu record XML could not be created for all invoices."
                    ),
